...
static NSString *const kEventPeerConnectionSelectedCandidatePairChanged =
    @"peerConnectionSelectedCandidatePairChanged";
...
static NSString *const kEventVideoTrackDimensionChanged = @"videoTrackDimensionChanged";
